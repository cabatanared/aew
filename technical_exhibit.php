...
<div class="main_content" style="margin: 1rem;">
...
<div class="article">
       <br>
        <div style="position: relative;min-height: 100vh; max-width: 1000px;width:80vw">
            ...
            <iframe class="responsive-iframe" src="https://drive.google.com/file/d/1wJN3o5mnMRjXieAOM9Oco4QMVHrFEZeK/preview" height="480" allow="autoplay"></iframe>
