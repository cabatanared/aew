...
<div class="main_content2" style="background: #FFF6CE;">
	...
	<div class="row">
		...
		<div class="article" style="margin: auto;">
	        <br>
	        <img style="max-width: 1000px;width: 100%;margin-bottom: 0.5rem" src="assets/banners/Tech Sessions.png" class="w3-container w3-center w3-animate-zoom">
	        <div class="row">
	        	<div id="schedule">
                    <div class="schedules">
              ...
              <a class="dl_pdf" href="https://drive.google.com/file/d/164HU8FqfYRppAV-QpfmGCRUQTN2rIoYF/view" target="_blank" style="text-decoration: none; position:absolute; z-index:2;color: #ffffff; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">Download</a>
