          ...
          <section class="pb_section bg-light foot_contain">
            ...
            <div class="row" style="margin: auto;width: 100%;">
              ...
              <div  id="footer" class="foot">
                 <!-- 
                  <div class="about_section">
                    ...
                    <a target="__blank" href="https://www.facebook.com/PNRIDOST/" style="text-decoration: none;color:white;">
                      <img id="lu" class="_6voz _7f2d img" src="assets/fb.png" alt="Follow us on Facebook" style="width:15px;">
                      <span class="fs">https://www.facebook.com/PNRIDOST/</span>
                    </a>
                  </div>

                  <div class="about_section" style="margin-top: 2rem;">
                    <h6 class="about_header">Visit our main website:</h6>
                    <a target="__blank" href="https://www.pnri.dost.gov.ph/" style="text-decoration: none;color:white;">
                      <span class="fs">https://www.pnri.dost.gov.ph/</span>
                    </a>
                  </div> -->
                  <br>
              ...
              <div  class="logo_slogan" style=" ">
                <center><img src="assets/logo/2023-AEW51-GearUp-Logo.png" id="event_title" class="aew_dec">
          ...
          <p id="copyright" class="copyright" style=""> Copyright © 2023 Philippine Nuclear Research Institute. All rights reserved.</p>
